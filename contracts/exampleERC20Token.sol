...
contract exampleERC20Token.sol is IERC20, IERC20Burnable, IERC20Pausable, IOwnable {
    /**
     * Token name.
     */
     ...
     */
    VotingPower public votingPowerContract;  // Reference to VotingPower contract
     ...
     * @param votingPowerAddress Address of the VotingPower contract.
     */
    constructor(address initialOwner, address votingPowerAddress) {
        _contractOwner = initialOwner;
        _paused = false;
        votingPowerContract = VotingPower(votingPowerAddress); // Initialize VotingPower contract
    ...
    function transferFrom(address sender, address recipient, uint256 amount) external override whenNotPaused returns (bool) {
        require(_allowances[sender][msg.sender] >= amount, "ChainewsToken: transfer amount exceeds allowance");
    ...
    function _transfer(address sender, address recipient, uint256 amount) internal {
        ...
        // Mark last update time for both sender and recipient
        // Update the balances in the VotingPower contract
    ...
    function _mint(address account, uint256 amount) internal {
        ...
        // Mark last update time and update balance in VotingPower contract
        votingPowerContract.updateWAHT(account, _balances[account]);
